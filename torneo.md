...
3.2. Los cubos serán colocados en las condiciones iniciales definidas al azar para cada intento, utilizando el [criterio definitdo acá](https://github.com/Universidad-Cenfotec/Vision-Rover-Challenge/tree/main/docs). Inicio de rovers, zonas de acopio no cambian.
