...
Cada cubo debe ser transportado por uno de los dos robots hasta su zona de acopio correspondiente.

La dificultad de cada escenario depende de dos factores principales.

1. La distancia que deben recorrer los cubos hasta sus respectivas zonas de acopio.

2. La posibilidad de que las trayectorias de transporte de los cubos interfieran entre sí, aumentando la necesidad de coordinación entre los robots.

El usuario puede seleccionar un nivel de dificultad DDD entre 0 y 1.
...
di=∣xi−xai∣+∣yi−yai∣d_i = |x_i-x_{a_i}|+|y_i-y_{a_i}|di=∣xi−xai∣+∣yi−yai∣

Donde:

* (xi,yi)(x_i,y_i)(xi,yi) representa el centro del cubo.

* (xai,yai)(x_{a_i},y_{a_i})(xai,yai) representa el centro de su zona de acopio.

* did_idi es la distancia del cubo iii a su zona de acopio, expresada en casillas.

La distancia media de los tres cubos se calcula mediante:

d‾=d1+d2+d33\overline{d}=\frac{d_1+d_2+d_3}{3}d=3d1+d2+d3

La aplicación utiliza el nivel de dificultad para establecer una distancia media objetivo:

dobjetivo=6.5+35Dd_{\text{objetivo}}=6.5+35Ddobjetivo=6.5+35D
...
L=0.55Ld+0.45Lc+ϵL=0.55L_d+0.45L_c+\epsilonL=0.55Ld+0.45Lc+ϵ

Donde:

Ld=∣d‾−dobjetivo∣36L_d=\frac{|\overline{d}-d_{\text{objetivo}}|}{36}Ld=36∣d−dobjetivo∣

Lc=∣C−Cobjetivo∣3L_c=\frac{|C-C_{\text{objetivo}}|}{3}Lc=3∣C−Cobjetivo∣

En estas expresiones:

* LdL_dLd mide la diferencia entre la distancia media obtenida y la distancia objetivo.

* LcL_cLc mide la diferencia entre las interferencias obtenidas y las interferencias objetivo.

* CCC representa el número de parejas de trayectorias con interferencia.

* ϵ\epsilonϵ es una pequeña perturbación aleatoria entre 0 y 0.06 que introduce variabilidad entre escenarios.
...
Por lo tanto, el nivel de dificultad permite generar escenarios con diferentes condiciones espaciales, pero no representa una medida absoluta del tiempo necesario para completar el reto ni de la probabilidad de éxito de los robots.
